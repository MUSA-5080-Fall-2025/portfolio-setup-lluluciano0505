...
- Noticed how Git is integrated in RStudio: I can see changes, commit, and then push through GitHub Desktop
- Practiced using dplyr functions like select(), filter(), and mutate() to work with datasets
- Learned that group_by() and summarize() go together — group prepares the data, summarize gives the actual stats
- Started using the pipe operator %>%, which makes the code read like a story (“take this, then do that…”)
